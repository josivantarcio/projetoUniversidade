...
CREATE TABLE end_prof (
    ...
    uf_cidade_id_end_aluno        NUMBER NOT NULL,
...
CREATE TABLE professor (
    id_prof                NUMBER NOT NULL,
    departamento_id_depart NUMBER NOT NULL,
    nome_prof              VARCHAR2(100 CHAR),
    sobrenome_prof         VARCHAR2(100 CHAR),
...
ALTER TABLE uf_cidade ADD CONSTRAINT uf_cidade_pk PRIMARY KEY ( id_end_aluno,
                                                                id_uf_cidade );
...
ALTER TABLE endereco_aluno
    ADD CONSTRAINT end_alu_uf_cid_fk FOREIGN KEY ( uf_cidade_id_end_aluno,
                                                   uf_cidade_id_uf_cidade )
        REFERENCES uf_cidade ( id_end_aluno,
                               id_uf_cidade );
...
ALTER TABLE end_prof
    ADD CONSTRAINT end_prof_uf_cidade_fk FOREIGN KEY ( uf_cidade_id_end_aluno,
                                                       uf_cidade_id_uf_cidade )
        REFERENCES uf_cidade ( id_end_aluno,
                               id_uf_cidade );
